"""
Django settings for parque_automotor project.
...
ROOT_URLCONF = 'parque_automotor.urls'
...
WSGI_APPLICATION = 'parque_automotor.wsgi.application'
...
# Email Config
EMAIL_SUBJECT_PREFIX = '[parque_automotor] '
DEFAULT_FROM_EMAIL = 'No Reply <no-reply@parque_automotor.com>'
SERVER_EMAIL = 'Server <server@parque_automotor.com>'
